...
for length in length_list:
    ...
    plt.title('Occurrence of 21 nucleotide long repeats in S. sulfataricus')
...
for length in length_list:
    ...
    plt.title('Occurrence of 22 nucleotide long repeats in S. sulfataricus')
    plt.xlabel('Unique repeats', color='green', fontsize=16)
    plt.ylabel('Frequency', color='green', fontsize=16)
    plt.savefig("22ntdrepeats.png", format="png")
    plt.show()

#Finding 23 nucleotides long repeat sequences and their frequency  
length_list = [23]
...
for length in length_list:
    ...
    plt.title('Occurrence of 23 nucleotide long repeats in S. sulfataricus')
    plt.xlabel('Unique repeats', color='green', fontsize=16)
    plt.ylabel('Frequency', color='green', fontsize=16)
...
def writehtml():
	...
	f.write("</style>\n")
	f.write("<h1> CRISPR repeat analysis in sulfolobus sulfataricus genomic DNA sequence </h1>\n")
	f.write("</head>")
	f.write("<body>\n")
	...
	f.write("<p> Recently I found that Sulfolobus sulfataricus contains DNA sequesnce similar to Cas12 genes. So to verify if these sequences are really Cas protein genes, we want to identify the CRISPR repeats downstream of promising Cas genes because these repeats are an integral part of CRISPR-Cas array. </p>\n")
